...
public class PlannerCallbacks : MonoBehaviour
{
    ...
    public IEnumerator Seek(GameObject treasure, GameObject copGO)
    {
        ...
        while ((Vector3.Distance(treasure.transform.position, transform.position) > 0.2f) &&
        ...
        //{
        //    trt.CopAway = false;
        //    Debug.Log("CopAway False");
        //}
        //else if (Vector3.Distance(treasure.transform.position, transform.position) < 0.2f)
        //{
