...
public class IsCopNear : ConditionBase
{
    public override bool Check()
    {
        ...
        Debug.Log(Vector3.Distance(cop.transform.position, treasure.transform.position));

        return Vector3.Distance(cop.transform.position, treasure.transform.position) < 0.2f;
    }
}