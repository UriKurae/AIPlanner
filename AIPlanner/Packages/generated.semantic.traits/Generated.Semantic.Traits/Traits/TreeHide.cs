...
namespace Generated.Semantic.Traits
{
    ...
    [AddComponentMenu("Semantic/Traits/TreeHide (Trait)")]
    [RequireComponent(typeof(SemanticObject))]
    public partial class TreeHide : MonoBehaviour, ITrait
    {
        ...
        public void Convert(Entity entity, EntityManager destinationManager, GameObjectConversionSystem _)
        {
            ...
            if (!destinationManager.HasComponent(entity, typeof(TreeHideData)))
            {
                destinationManager.AddComponent<TreeHideData>(entity);
            }
        }
        ...
        void OnDestroy()
        {
            ...
            {
                m_EntityManager.RemoveComponent<TreeHideData>(m_Entity);
        ...
        void OnDrawGizmos()
        {
            TraitGizmos.DrawGizmoForTrait(nameof(TreeHideData), gameObject,null);
        }
#endif
    }
}
